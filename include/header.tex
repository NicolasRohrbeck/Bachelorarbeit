...
% Zeilenumbrüche in URLs (normalerweise ist - ein unumbrechbares Zeichen)
...
\usepackage[backend=biber, citestyle=authoryear, bibstyle=authoryear , urldate=comp, dateabbrev=false]{biblatex}
